...
/// </summary>
public class LegacyRetryStrategy : IRetryStrategy
{
    ...
    /// </summary>
    public LegacyRetryStrategy(RetryStrategySettings retryStrategySettings, IRebusLoggerFactory rebusLoggerFactory, IErrorTracker errorTracker, IErrorHandler errorHandler, IFailFastChecker failFastChecker, IExceptionInfoFactory exceptionInfoFactory, CancellationToken cancellationToken)
    {
    ...
    /// <summary>
    /// Gets the retry step with appropriate settings for this <see cref="LegacyRetryStrategy"/>
    /// </summary>
    public IRetryStep GetRetryStep() => new LegacyRetryStep(
        _rebusLoggerFactory,
        _errorHandler,
        _errorTracker,
        _failFastChecker,
