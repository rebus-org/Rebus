...
namespace Rebus.Exceptions
{
    ...
    public static class TransportMessageApiExtensions
    {
        ...
        /// </summary>
        public static async Task Deadletter(this ITransportMessageApi transportMessageApi, string errorDetails = null,
            bool throwIfAlreadyDeadlettered = true)
        {
        ...
        /// </summary>
        public static async Task Deadletter(this ITransportMessageApi transportMessageApi, Exception exception,
            bool throwIfAlreadyDeadlettered = true)
        {
            if (transportMessageApi == null) throw new ArgumentNullException(nameof(transportMessageApi));
        ...
        {
            var context = MessageContext.Current ?? throw new InvalidOperationException(
                $"Attempted to dead-letter the current message using exception '{exception}', but no message context could be found! This is probably a sign that this method was called OUTSIDE of a Rebus handler, or on a separate, disconnected thread somehow. Please only call this method inside Rebus handlers.");
