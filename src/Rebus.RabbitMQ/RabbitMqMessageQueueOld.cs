...
{
    public class RabbitMqMessageQueueOld : ISendMessages, IReceiveMessages, IDisposable
    {
        static ILog log;

        static RabbitMqMessageQueueOld()
        {
        ...
        public RabbitMqMessageQueueOld(string connectionString, string inputQueueName)
        {
        ...
        public RabbitMqMessageQueueOld PurgeInputQueue()
        {
            using (var localModel = connection.CreateModel())
            {
