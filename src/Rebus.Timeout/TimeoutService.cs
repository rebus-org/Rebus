...
namespace Rebus.Timeout
{
    public class TimeoutService : IActivateHandlers
    {
        ...
        private RebusBus rebusBus;

        private static readonly Type[] IgnoredMessageTypes =
            new[]
                {
                    typeof (object),
        ...
        private void Initialize(IStoreTimeouts storeTimeouts, ISendMessages sendMessages, IReceiveMessages receiveMessages, string errorQueueName)
        {
            ...
            rebusBus = new RebusBus(this, sendMessages, receiveMessages, null, null, null, null, null,
